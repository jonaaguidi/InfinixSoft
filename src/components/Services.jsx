      ...
      <div id="services" className="w-full bg-[#242427]">
        <section className="max-w-[1220px] relative bg-[#242427] py-20 mx-auto flex flex-col items-center max-[1350px]:px-14 max-[520px]:px-7">
          <div className="max-w-[538px] flex flex-col self-start">
            <p className="badge w-fit z-10 font-normal pb-2">{t("servicesBadge")}</p>
          ...
          <div className="max-w-[1220px]  flex justify-start  flex-wrap pt-20 gap-6 max-[1350px]:gap-4 max-[1163px]:justify-center max-[1163px]:gap-6">
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service1} width={42} height={42} alt={t("service1Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service2} width={42} height={42} alt={t("service2Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service3} width={42} height={42} alt={t("service3Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service4} width={42} height={42} alt={t("service4Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service5} width={42} height={42} alt={t("service5Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service6} width={42} height={42} alt={t("service6Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service7} width={42} height={42} alt={t("service7Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service8} width={42} height={42} alt={t("service8Title")} />
            ...
            <div className="max-w-[390px] z-10 relative max-[1350px]:w-[340px] max-[1163px]:w-[390px] max-[916px]:w-[340px] max-[816px]:w-[396px] max-[440px]:w-[320px]">
              <div className="flex flex-col justify-center p-10 bg-cards h-[316px] rounded-[12px] border-2 border-[#313134] z-20 max-[1350px]:h-[352px] max-[916px]:h-[364px] max-[440px]:h-[348px]">
                <img className="pb-6" src={service4} width={42} height={42} alt={t("service9Title")} />
