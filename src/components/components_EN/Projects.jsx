...
import { BsAndroid2, BsApple, BsFillArrowRightCircleFill, BsFillCreditCard2BackFill } from "react-icons/bs";
...
const Projects = () => {
  return (
    <section className="max-w-[1220px] mx-auto py-20 max-[1024px]:py-10 max-[860px]:px-14 max-[480px]:px-7">

      <div className="max-w-[838px] py-20 mx-auto flex flex-col justify-center items-center max-[1024px]:py-10">
      ...
      <div id="projects" className="flex items-center justify-center max-[1210px]:scale-90 max-[1040px]:flex-col max-[1040px]:scale-100" >
