...
const Partners = () => {
    ...
    return (
        <section className={`w-full z-max flex flex-col justify-center items-center mx-auto py-20 ${windowWidth < 768 ? "pb-20" : "pb-60"}`}>
            ...
            <div className="max-w-[1420px] flex flex-col gap-20 max-[1024px]:scale-[0.80] max-[900px]:scale-[0.70] max-xl:max-w-[1100px] max-lg:max-w-[900px] max-md:max-w-[680px] max-sm:max-w-[380px]">
                <Marquee
