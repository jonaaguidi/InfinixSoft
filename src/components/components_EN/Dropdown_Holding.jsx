...
const Dropdown_Holding = () => {
  return (
    <div  className="animate-fade-up animate-duration-[650ms] animate-delay-25 w-fit bg-[#171718] border border-[#db3957] shadow-navbar p-3 rounded-lg absolute top-24 left-48 max-[580px]:left-16">
