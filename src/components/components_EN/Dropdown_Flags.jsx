  ...
  return (
    <div className="animate-fade-up animate-duration-[650ms] animate-delay-25 w-fit absolute bg-[#171718] shadow-navbar p-2 rounded-lg top-24 max-[469px]:left-58">
      <div className="flex flex-col rounded-lg items-center w-fit">
        <a
          href="/es"
          className="flex items-center gap-2 cursor-pointer mb-1 p-2 rounded-lg font-semibold hover:bg-black focus:bg-black hover:text-[#DB3957]"
          target='_blank'
          rel='noreferrer'>
        ...
        <a
          href="/br"
          className="flex items-center gap-2 cursor-pointer p-2 rounded-lg font-semibold hover:bg-black focus:bg-black hover:text-[#DB3957]"
          target='_blank'
          rel='noreferrer'>
