...
const Projects_Cards = () => {
    return (
        <section className="max-w-[1220px] flex flex-col justify-center items-center mx-auto py-10">
            ...
            <div className="max-w-[1220px] mx-auto pb-12 py-2 flex gap-20 flex-wrap items-center justify-center">
            ...
            <button className="button-primary flex items-center justify-center gap-2 max-w-fit transition duration-400 hover:shadow-button">
                <a>
                    View More
                </a>
                <span className="text-[16px] mt-[1px]"><BsFillPlusCircleFill /></span>
            </button>
