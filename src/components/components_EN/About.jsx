...
const About = () => {
    ...
    return (
        <section id="about" className="w-fit h-[680px] mx-auto px-28 py-20 mb-20 flex items-center justify-center gap-10 max-[1300px]:gap-4 max-[950px]:gap-0 max-[880px]:px-14 max-[675px]:px-7">
            ...
            <img width={616} className="rounded-2xl max-[950px]:hidden" src={AboutImage} alt="About"></img>
            ...
            <div className=" max-w-[494px] flex flex-col justify-center">
                ...
                <div className="w-fit max-w-[428px] flex flex-col items-start pb-6">
                    ...
                    <h2 className="mt-1 font-bold text-[42px] text-[#F4F5F6] max-[1120px]:text-2xl">About Us</h2>
                </div>

                <div className="pb-10">
                    <p className="text-[18px] font-normal pb-[18px] leading-[150%]">
                ...
                <div className="max-w-[494px] max-h-24 flex items-center gap-12 max-[1384px]:gap-2 max-[1384px]:pt-8 max-[485px]:gap-10 max-[485px]:pt-4 max-[485px]:flex-wrap max-[485px]:justify-center">
