...
const About = () => {
  return (
    <section className="w-fit h-fit mx-auto px-28 py-20 flex items-center justify-between gap-24 ">
        <div>
            <img className="rounded-2xl absolute blur-2xl z-0" src={AboutImage} alt="About"></img>
            <img className="rounded-2xl relative " src={AboutImage} alt="About" width={448} height={600}></img>
        </div>
