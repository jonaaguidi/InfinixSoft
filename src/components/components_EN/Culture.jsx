  ...
  return (
    <section className="w-full py-20 px-28 flex flex-col items-center max-[1000px]:px-14 max-[425px]:px-7">
      <div className="max-w-[838px] flex flex-col justify-center items-center  ">
        <h2 className="max-w-[888px] text-[#FCFCFD] text-[42px] text-center leading-[50px] max-[1024px]:text-[32px] max-[455px]:text-[24px] max-[455px]:leading-8">
          Nuestros Valores:<span className="font-bold"> La Base de Nuestra Cultura Empresarial</span>
        </h2>
        <h4 className="max-w-[720px] text-xl text-[#A1A1A9] text-center pt-4 pb-8 leading-[30px] max-[1024px]:text-[16px] max-[455px]:text-[14px] max-[455px]:leading-6">
