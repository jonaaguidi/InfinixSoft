...
const Card_Projects = ({ image, title, subtitle }) => {
  ...
  return (
    <Tilt options={defaultOptions} id="Card_project" className="w-[328px] h-[427px] relative z-full px-6 py-10 border-gradient_2 flex flex-col items-center justify-center">
