...
const Dropdown = () => {
  return (
    <div  className="animate-fade-up animate-duration-[650ms] animate-delay-25 w-fit bg-[#242427] border border-[#db3957] p-3 rounded-lg absolute top-20 left-56 max-[580px]:left-32">
