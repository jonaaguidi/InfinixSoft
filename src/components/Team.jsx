    ...
    <section className="max-w-[1220px] py-20 mx-auto flex flex-col ">
      ...
      <div className="flex items-start justify-start gap-x-11 gap-y-10 flex-wrap max-[1350px]:px-14 max-[1350px]:gap-x-7 max-[669px]:justify-center max-[580px]:px-7 max-[580px]:gap-x-5">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={ivan} alt="Ivan Saroka"></img>
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={marcos} alt={t("marcosName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
          {t("marcosName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={hernan} alt={t("hernanName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("hernanName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={marcela} alt={t("marcelaName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("marcelaName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={martin} alt={t("martinName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("martinName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={ale} alt={t("aleName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("aleName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={jero} alt={t("jeroName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("jeroName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={luis} alt={t("luisName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("luisName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={fernando} alt={t("ferName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("ferName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={valeria} alt={t("valeName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("valeName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={ayelen} alt={t("ayeName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("ayeName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
        ...
        <div className="flex flex-col items-center justify-center member z-10 max-w-[170px] h-fit max-[580px]:max-w-[156px] max-[458px]:max-w-[146px]">
          <img className="opacity-80" src={lis} alt={t("lisName")}></img>
          <p className="text-[14px] font-bold text-white text-center">
            {t("lisName")}
          </p>
          <p className="text-[12px] font-normal text-[#A1A1A9] text-center">
